...
CANDIDATE_OF = {
    "Edible_Insects": ("Agriculture", "Edible Insects"),
    "Medicinal_Plants": ("Agriculture", "Medicinal Plants"),
    "Origin_of_Life_Photochemistry": ("Photosynthesis_and_Gas_Exchange",
                                      "Origin of Life Photochemistry"),
    "UV_Radiation_and_Vitamin_D": ("Solar_Radiation_Modelling",
                                   "UV Radiation and Vitamin D"),
    "Mediterranean_Forest_History": ("Unsorted", "Mediterranean Forest History"),
...
MANUAL_OVERRIDES = {
    "67RDEWXY": ("Energy_Market_and_Grid_Data", "Nord Pool historical data, duplicate record"),
    "NCN7YI3E": ("Vertical_Farming_and_Urban_Agriculture", "year-round production under artificial light"),
    "X5EGHXP2": ("Photosynthesis_and_Gas_Exchange", "general plant physiology textbook, not a carbon-water candidate"),
    "8M465C7I": ("PV_Economics_and_LCA", "commercial operation and direct marketing of PV plants"),
    "NE2KRF5T": ("Global_Datasets_and_Catalogs", "FAO AQUASTAT water use database"),
    "7CD4EQ8S": ("Global_Datasets_and_Catalogs", "UN World Population Prospects"),
    "ZTABB4UP": ("Energy_Market_and_Grid_Data", "international fuel price series"),
    "K6FD625T": ("Climate_Change", "Indonesian primary forest loss"),
    "43DMK9F2": ("Climate_Change", "palaeo land environments since the last interglacial"),
    "8M9NNFFB": ("Cartography_and_Map_Design", "vegetation map of Europe"),
    "PSUASKH9": ("Solar_Radiation_Modelling", "Duffie & Beckman solar engineering"),
    "YQK7FXPD": ("Solar_Radiation_Modelling", "applied solar energy textbook"),
    "29EMMB7R": ("Solar_Radiation_Modelling", "daylength and twilight calculation"),
    "2TL4MEM6": ("Solar_Radiation_Modelling", "Kasten & Young air mass"),
    "8BPEBJAA": ("Photoperiod_and_Dormancy_Induction", "experimental control of the spruce life cycle"),
    "4LHEMFLD": ("Photosynthesis_and_Gas_Exchange", "Blackman limiting factors"),
    "MKE3LAQZ": ("Horticultural_Lighting", "dimensions of light for plant growth"),
    "I5PPYSJK": ("Greenhouse_Horticulture", "horticultural reviews series"),
    "UB2T4CVS": ("Agriculture", "agricultural water use monitoring"),
    "FYMXGPEJ": ("Agrivoltaics", "first Swedish agrivoltaic system, project record"),
    "T7ABVXTD": ("Edible_Insects", "edible insects in food systems"),
    "4WVBVWDV": ("Edible_Insects", "LCA of edible insects"),
    "LQJZ5DJJ": ("Edible_Insects", "forest insects as food"),
    "4SKCGAF3": ("Edible_Insects", "grasshopper rearing patent"),
    "NREJMI2A": ("Medicinal_Plants", "Mexican medicinal herbal of 1552"),
    "DXE2AZBN": ("Medicinal_Plants", "medicinal plant species count"),
    "TQDFZ7NX": ("Origin_of_Life_Photochemistry", "UV-driven prebiotic synthesis"),
    "9N6FRCMN": ("Origin_of_Life_Photochemistry", "energy at life's origin"),
    "7RRL2MZW": ("UV_Radiation_and_Vitamin_D", "sunlight and vitamin D"),
    "M8GK7W8Z": ("UV_Radiation_and_Vitamin_D", "UV exposure and vitamin D status"),
    "TFRZJ9Q6": ("UV_Radiation_and_Vitamin_D", "duration of vitamin D synthesis by latitude"),
    "DEE9S9TZ": ("Mediterranean_Forest_History", "Balearic forest use"),
    "6H6DEVZM": ("Mediterranean_Forest_History", "Balearic forest landscape history"),
    "NNSLYY7B": ("Climate_Change", "FAOSTAT AFOLU emissions report"),
    "989BFQUT": ("Urban_Planning", "urban trees versus solar access"),
    "BAG8U5IX": ("Forestry_and_Agriculture_Statistics", "Eurostat agriculture and forestry statistics"),
    "KHFQ56B4": ("Vertical_Farming_and_Urban_Agriculture", "plant factory energy cost, method is incidental"),
    "TR4SYDFR": ("Swedish_Forestry", "regional growth of spruce, pine and birch"),
    "2IW8BVJE": ("PV_Standards_and_Measurement", "inverter measurement accuracy"),
    "FTC5BYYA": ("PV_Standards_and_Measurement", "uncertainty in PV performance parameters"),
    "K2W6TP8L": ("PV_Standards_and_Measurement", "uncertainty of outdoor module power rating"),
    "A2A2QYSG": ("PV_System_Performance", "statistics of PV plant data for energy planning"),
    "BLDUVHY9": ("R", "emmeans package"),
    "W6JDGGFF": ("R", "emmeans package, duplicate record"),
    "R7PHWNJ6": ("R", "lme4 software paper"),
    "E3IE7WII": ("R", "tidy data, tidyverse foundation"),
    "4IU35SF9": ("R", "The R Book, general R reference"),
    "D5N4LMRM": ("Solar_and_Weather_Data", "ERA5 reanalysis"),
    "96TJHKMH": ("Solar_and_Weather_Data", "ERA5 hourly single-level data"),
    "5W6HJEDA": ("Radiometry_and_Photometry", "light measurement handbook"),
    "SD6CKTHU": ("Forest_Seedling_Production", "LCA inventory for plant production"),
    ...
    "5JXWEGET": ("Forest_Damage_and_Herbivory", "bark weevil biology"),
    "95WYG2J6": ("Forest_Damage_and_Herbivory", "pine weevil damage and survival"),
    "U2BQMC7H": ("Forest_Damage_and_Herbivory", "pine weevil countermeasures"),
    "7UU35SD4": ("Forest_Damage_and_Herbivory", "pine weevil research portal"),
    "RUPTV5EV": ("Forest_Damage_and_Herbivory", "pine weevil feeding"),
    "II3M9AN9": ("Forest_Damage_and_Herbivory", "frost damage to planted seedlings"),
    "CDTLAIQB": ("Forest_Damage_and_Herbivory", "frost and other climate damage"),
    "SC9JIAMP": ("Forest_Damage_and_Herbivory", "near-ground temperature and frost damage"),
    "HD6QJ3CE": ("Tree_Breeding_and_Propagation", "transfer of forest reproductive material"),
    "YSBDZEAN": ("Tree_Breeding_and_Propagation", "European tree breeding best practice"),
    "ER5ERQEB": ("Tree_Breeding_and_Propagation", "choice of regeneration material"),
    "SRT29LUF": ("Tree_Breeding_and_Propagation", "performance and genetic variation"),
    "HU7L8PJP": ("Photoinhibition_and_Light_Stress", "photoinhibition in reforestation"),
    "WIYVFHHC": ("Seedling_Storage_and_Handling", "fall acclimation and the lift/store pathway"),
    "E4T3CCNC": ("Seedling_Storage_and_Handling", "care and handling from storage to outplanting"),
    "ZALHEEQL": ("Forest_Seedling_Production", "nursery facilities and staff"),
    "NBYP45AL": ("Seedling_Quality_and_Root_Growth_Potential", "seedling size and reforestation success"),
    "85VE528I": ("Seedling_Quality_and_Root_Growth_Potential", "target plant concept in restoration"),
    "6D85BWXF": ("Seedling_Quality_and_Root_Growth_Potential", "optimum seedling size"),
    ...
    "5R6DYIRN": ("Forest_Seedling_Production", "miniplant culture, storage and planting"),
    "6ADPW8LY": ("Forest_Seedling_Production", "winter freezer storage of miniplants"),
    "4X7Q23NR": ("Forest_Seedling_Production", "miniplant field trial results"),
    "UMWYMSDQ": ("Forest_Seedling_Production", "miniplant field trials"),
    "U5C5W6RJ": ("Forest_Seedling_Production", "growing container seedlings in greenhouses"),
    "CAUNMVS2": ("Forest_Seedling_Production", "root growth in larch seedlings"),
    "MJBQ8AE9": ("Forest_Seedling_Production", "seedling size and early performance"),
    "FUGPX7NN": ("Swedish_Forestry", "Holmen forest management"),
    "PYZNFRYR": ("Swedish_Forestry", "Late-Glacial boreal forest history"),
    "9IDNRSZG": ("Forest_Regeneration", "site preparation with miniplants"),
    "B9VSS46Q": ("Forest_Regeneration", "Scandinavian regeneration practice"),
    "ITGV38YQ": ("Forest_Regeneration", "extending the planting period"),
    "BUE2Z3XW": ("Forest_Regeneration", "drought on summer-planted seedlings"),
    "EVQ3QBX8": ("Greenhouse_Horticulture", "growth chamber uniformity"),
    "JF6XMCSV": ("Greenhouse_Horticulture", "growth chamber temperature control"),
    "4VV4V4FB": ("Greenhouse_Horticulture", "growth chamber temperature chapter"),
    "KZGIRNML": ("Frost_Hardiness_and_Freezing_Tests", "molecular biology of conifer frost tolerance"),
    "25SVKMQ2": ("Frost_Hardiness_and_Freezing_Tests", "frost hardening and photosynthesis in pine"),
    "UXRRGQQP": ("Frost_Hardiness_and_Freezing_Tests", "root freezing equipment and testing"),
    "DLTST7KF": ("Frost_Hardiness_and_Freezing_Tests", "seasonal root hardiness"),
    "EUQ689NW": ("Frost_Hardiness_and_Freezing_Tests", "root-zone freezing temperatures"),
    "VE6WHYFE": ("Frost_Hardiness_and_Freezing_Tests", "outdoor winter storage root temperatures"),
    "E4UAGANE": ("Frost_Hardiness_and_Freezing_Tests", "cold storage and planting date"),
    "XVM4KD5Z": ("Frost_Hardiness_and_Freezing_Tests", "gene activity cold tolerance test"),
    "AINY57VS": ("Frost_Hardiness_and_Freezing_Tests", "cold tolerance test for conifer seedlings"),
